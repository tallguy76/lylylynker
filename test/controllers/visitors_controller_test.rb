...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { email_address: @visitor.email_address, ip_address: @visitor.ip_address, link_item_id: @visitor.link_item_id, referrer: @visitor.referrer }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { email_address: @visitor.email_address, ip_address: @visitor.ip_address, link_item_id: @visitor.link_item_id, referrer: @visitor.referrer }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
